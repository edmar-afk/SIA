...
//*****************************************************************************
var question1 = {
                  question: "OBSERVATION OF THE WORK ENVIRONMENT.",
                  answers: ["FACT – FINDING METHODS", "SYSTEMS REQUIREMENTS", "REQUIREMENTS ELICITATION"],
                  correct: 0
                };

var question2 = {
                  question: "These are statements in Natural language plus diagrams of services the system provides, together with its operational constraints.",
                  answers: ['Functional requirements', 'System requirements', 'User Requirements', 'NFR'],
                  correct: 2
                };

var question3 = {
                  question: 'Interfaces with other systems',
                  answers: ['Interface requirements', 'Security', 'Operating requirements', 'Economic requirements'],
                  correct: 1
                }

var question4 = {
                  question: "Describe what the system should do.",
                  answers: ["Functional requirements", "INTERVIEWS", "Controls"],
                  correct: 0
                };

var question5 = {
                  question: "One of Characteristics or features that must be included to satisfy business requirements",
                  answers: ["Volumes. sizes, and frequencies", "RESEARCH AND SITE VISITS."],
                  correct: 0
                };

var question6 = {
                  question: "Maintainability, Enhanciability, Portability, expected market or product lifespan.",
                  answers: ["Security", "Interface requirements", "Performance requirements","Lifecycle requirements"],
                  correct: 3
                };

var question7 = {
                  question: "Non-functional requirements describe what the system should do",
                  answers: ["True", "False"],
                  correct: 1
                };
