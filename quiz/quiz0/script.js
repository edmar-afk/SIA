...
//*****************************************************************************
var question1 = {
                  question: "The starting point of the requirements engineering process is an elicitation process that involves a number of people to ensure consideration of a broad scope of potential ideas and candidate problems.",
                  answers: ["ELICITATION PHASE", "PROTOTYPE PHASE", "ANALYSIS PHASE"],
                  correct: 0
                };

var question2 = {
                  question: "statements that identify the essential needs of a system in order for it to have value and utility.",
                  answers: ['USE CASE', 'Diagram', 'REQUIREMENTS', ' Requirements Life Cycle'],
                  correct: 2
                };

var question3 = {
                  question: 'This represents a transformation.',
                  answers: ['REQUIREMENTS DOCUMENTATION AND SPECIFICATION', 'ANALYSIS PHASE', 'PROTOTYPE PHASE', 'ELICITATION PHASE'],
                  correct: 1
                }

var question4 = {
                  question: "This represents the requirements as the finished product of the stakeholder requirements team.",
                  answers: ["REQUIREMENTS LIFE CYCLE", "REQUIREMENTS", "REQUIREMENTS DOCUMENTATION AND SPECIFICATION"],
                  correct: 2
                };

var question5 = {
                  question: "The words optimize, maximize, and minimize should not be used in stating requirements, because we could never prove that we had achieved them.",
                  answers: ["True", "False"],
                  correct: 0
                };

var question6 = {
                  question: "In this way poorly understood requirements may be tested and perhaps strengthened, corrected, or refined.",
                  answers: ["ANALYSIS PHASE", "ELICITATION PHASE", "Activity Diagram","PROTOTYPE PHASE"],
                  correct: 3
                };

var question7 = {
                  question: "ONE OF CHARACTERISTICS OF GOOD REQUIREMENTS IS  QUNATITATIVE BUT NOT TESTABLE.",
                  answers: ["True", "False"],
                  correct: 1
                };
